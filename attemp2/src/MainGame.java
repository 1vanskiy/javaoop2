...
public class MainGame {
    public static void main(String[] args) {
        ...
        ComputerVideoGame computerGame = new ComputerVideoGame("PUBG MOBILE", "Action RPG");
        ...
        ConsoleVideoGame consoleGame = new ConsoleVideoGame("The Last of Us Part II", "PlayStation 5");
